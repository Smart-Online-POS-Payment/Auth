...
class VerifyController(
    ...
    suspend fun isCustomerVerified(@PathVariable customerId: String): Boolean {
        return verifyService.isCustomerVerified(customerId)
    }

    @GetMapping("/customer/{customerId}")
    suspend fun getCustomerVerificationInfo(@PathVariable customerId: String): VerifiedUserEntity {
